...
const s = {
  ...
  titleInput: { width:'100%', padding:'0.65rem 0.75rem', background:'#FAF8F3', border:'1.5px solid #E2D9CC', borderRadius:'var(--radius-sm)', fontSize:'0.95rem', fontFamily:'var(--font-serif)', fontWeight:500, color:'var(--charcoal)', outline:'none', transition:'border-color 0.2s, box-shadow 0.2s', boxSizing:'border-box' },
  contentInput: { width:'100%', padding:'0.65rem 0.75rem', background:'#FAF8F3', border:'1.5px solid #E2D9CC', borderRadius:'var(--radius-sm)', fontSize:'0.875rem', fontFamily:'var(--font-sans)', color:'var(--charcoal)', outline:'none', resize:'vertical', lineHeight:1.65, transition:'border-color 0.2s, box-shadow 0.2s', boxSizing:'border-box' },
  ...
  saveBtn: { display:'flex', alignItems:'center', gap:'0.4rem', background:'#B8956A', color:'white', border:'none', borderRadius:'var(--radius-sm)', padding:'0.5rem 1.1rem', fontSize:'0.82rem', fontWeight:600, fontFamily:'var(--font-sans)', transition:'opacity 0.2s, box-shadow 0.2s', whiteSpace:'nowrap', boxShadow:'0 3px 10px rgba(184,149,106,0.35)' },
}