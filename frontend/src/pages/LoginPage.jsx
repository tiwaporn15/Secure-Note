...
const s = {
  ...
  navLogoText: { fontFamily:'var(--font-serif)', fontSize:'1.2rem', fontWeight:600, color:'#2D251F', letterSpacing:'0.02em' },
  navLinksDesktop: { display:'flex', alignItems:'center', gap:'2rem' },
  navLink: { fontSize:'0.95rem', color:'#5A4E43', textDecoration:'none', fontWeight:500, transition:'color 0.2s', cursor:'pointer', background:'none', border:'none', fontFamily:'inherit' },
  navActionBtn: { background:'#D4A574', color:'white', border:'none', padding:'0.6rem 1.5rem', borderRadius:'8px', fontSize:'0.9rem', fontWeight:600, cursor:'pointer', transition:'background 0.2s' },
  ...
  mobileActionBtn: { background:'#D4A574', color:'white', border:'none', padding:'0.6rem 1.5rem', borderRadius:'8px', fontSize:'0.9rem', fontWeight:600, cursor:'pointer', width:'100%' },
  ...
  submitBtn: { display:'flex', alignItems:'center', justifyContent:'center', gap:'0.5rem', background:'#D4A574', color:'white', border:'none', borderRadius:'var(--radius-sm)', padding:'0.875rem 1.5rem', fontSize:'0.9rem', fontWeight:500, fontFamily:'var(--font-sans)', transition:'background 0.2s, box-shadow 0.2s', boxShadow:'var(--shadow-sm)', width:'100%' },
  ...
  switchTabBtn: { background:'none', border:'none', color:'#A6845C', fontWeight:600, fontSize:'0.75rem', cursor:'pointer', textDecoration:'underline', padding:0 },
